...
#### 1.1b Using Gazebo:
    ...
    ros2 launch linorobot2_gazebo gazebo.launch.py rviz:=true world:=worlds/empty.world
...
#### 4.2 Run [Nav2](https://navigation.ros.org/tutorials/docs/navigation2_on_real_turtlebot3.html) package:
    ...
    ros2 launch linorobot2_navigation navigation.launch.py sim:=true rviz:=true map:=/home/heithhara/linorobot2_ws/src/linorobot2/linorobot2_navigation/maps/my_playground.yaml
